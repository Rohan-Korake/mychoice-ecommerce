            ...
            <div className="hidden flex-1 px-6 md:flex">
              <div className="relative w-full max-w-xl">
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-slate-300 bg-slate-100 pl-4 pr-12 text-sm outline-none transition focus:border-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:focus:border-white"
                />
                    ...
                    className={({ isActive }) =>
                      `inline-flex items-center border-b-2 px-1 py-2 text-sm font-medium transition-colors duration-200 ${
                        isActive
                          ...
                          : "border-transparent text-slate-700 hover:border-slate-300 hover:text-slate-900 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:text-white"
                      }`
                    }
                  >
                    {nav.name}
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex w-full items-center justify-center rounded-xl px-4 py-3 text-sm font-medium transition-all duration-200 border-1 ${
                          isActive
                            ? "bg-sky-500 text-white shadow-md hover:bg-sky-600 dark:bg-sky-500 dark:hover:bg-sky-400"
